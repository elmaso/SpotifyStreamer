...
/*
* An Abstract class that holds functionality used by both SearchActivity and TrackListActivity.
*/
public abstract class SpotiStreamerActivity extends AppCompatActivity {
    ...
    */
    protected Intent createShareTrackIntent() {
        ...
        * If no song is plaing return Null
        */
        String shareMsg =
                prefs.getString(PREF_CURRENT_TRACK_URL, "") + NEWLINE + NEWLINE +
                        ...
                        "Album: " + prefs.getString(PREF_CURRENT_ALBUM, "") + NEWLINE +
                        "Spoti Streamer baby !!!!!";
    ...
    protected void handleNowPlayingAction() {
        ...
        * TrackPlayingActivity.  Set RESET_ON_STARTUP to false so we don't restart the currently
