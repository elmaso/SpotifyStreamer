package udacity.mariosoberanis.spotifystreamer.adapters;
...
public class TrackListAdapter extends CursorAdapter {
    ...
    */
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        viewHolder.trackName.setText(cursor.getString(SpotiProvider.TRACKS_BY_ARTIST_TRACK_NAME));
        viewHolder.albumName.setText(cursor.getString(SpotiProvider.TRACKS_BY_ARTIST_ALBUM_NAME));

        Picasso.with(context)
                .load(cursor.getString(SpotiProvider.TRACKS_BY_ARTIST_TRACK_ICON))
