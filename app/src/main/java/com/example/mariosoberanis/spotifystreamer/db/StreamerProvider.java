package com.example.mariosoberanis.spotifystreamer.db;
...
import com.example.mariosoberanis.spotifystreamer.R;
import com.example.mariosoberanis.spotifystreamer.SearchActivity;
import com.example.mariosoberanis.spotifystreamer.utility.ImageUtils;
...
/**
 * Created by mariosoberanis on 7/27/15.
 */
public class StreamerProvider extends ContentProvider {
   ...
   */
    ...
    /*
      ...
      * better performances = happier user = more likley to pay
      */
...
//    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
     ...
     /*
    * This method  handles all the work needed to get the set of artists
    ...
    */
    ...
    private Cursor getArtists(Uri uri, SQLiteDatabase db, Date cacheCutOffTime) {
        ...
        */
        ...
        if (checkForCachedQueryCursor.moveToFirst()) {
            ...
            Log.d(TAG, "Record exists in Query: " + query);
            ...
            if ((queryCreateTime != null) && (queryCreateTime.after(cacheCutOffTime))) {
                ...
                try {
                    ...
                    */
                    ...
                    Log.d(TAG, "Successfully retrieved artists: " + query);
    ...
    private long createArtistRecord(SQLiteDatabase db, Artist artist) {
        ...
        * Note, we don't try to perform an Update, always insert.
        * The table definition has a unique constraint on the Artist table such that if a duplicate
    ...
    */
    private Cursor getTracks(long artistId, String artistSpotifyId, SQLiteDatabase db,
        ...
        String countryCode = settings.getString(SearchActivity.PREF_COUNTRY_CODE, "US").toUpperCase();
