...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        ...
        mContext.getContentResolver().delete(
                SpotiContract.BASE_CONTENT_URI,
                null,
                null
        );
    }
        ...
        try {
            ...
            assertEquals(
                    "Error: StreamerProvider registered with authority: " +
                            ...
                            " instead of authority: " + SpotiContract.CONTENT_AUTHORITY,
                    providerInfo.authority, SpotiContract.CONTENT_AUTHORITY);
...
//        deleteAllRecordsFromProvider();
    ...
    public void testGetType() {
        ...
        String type = mContext.getContentResolver().getType(
                SpotiContract.GET_ARTISTS_CONTENT_URI
                        .buildUpon()
                        .appendEncodedPath("a")
                        .build());

        assertEquals(SpotiContract.GET_ARTISTS_CONTENT_TYPE, type);

        type = mContext.getContentResolver().getType(
                SpotiContract.GET_TRACKS_CONTENT_URI
                        .buildUpon()
                        .appendEncodedPath("a")
                        .build());

        assertEquals(SpotiContract.GET_TRACKS_CONTENT_TYPE, type);
    }
    ...
    */
    public void testArtistQuery_1() {
        ...
        cursor = mContext.getContentResolver().query(
                SpotiContract.GET_ARTISTS_CONTENT_URI.buildUpon().appendEncodedPath(query).build(),
                null,
                null,
                null,
                null);
        ...
        */
        ...
        String result = compareResults(cursor, expectedResults, SpotiProvider.ARTISTS_BY_QUERY_SPOTIFY_ID);
    ...
    public void testTrackQuery_1() {
        ...
        */
        mContext.getContentResolver().query(
                SpotiContract.GET_ARTISTS_CONTENT_URI.buildUpon().appendEncodedPath(artistName).build(),
                null,
                null,
                null,
                null);
        ...
        Cursor cursor = mContext.getContentResolver().query(
                SpotiContract.GET_TRACKS_CONTENT_URI.buildUpon().appendEncodedPath(artistSpotifyId).build(),
                null,
                null,
                null,
                null);
        ...
        String result = compareResults(cursor, expectedResults, SpotiProvider.TRACKS_BY_ARTIST_TRACK_SPOTIFY_ID);
        assertNull(result, result);
    }
