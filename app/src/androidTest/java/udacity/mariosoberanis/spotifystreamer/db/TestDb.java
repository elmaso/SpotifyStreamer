...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(SpotiDbHelper.DATABASE_NAME);
    }
    ...
    public void testCreateDb() throws Throwable {
        ...
        tableNameHashSet.add(SpotiContract.ArtistEntry.TABLE_NAME);
        tableNameHashSet.add(SpotiContract.TrackEntry.TABLE_NAME);
        tableNameHashSet.add(SpotiContract.QueryEntry.TABLE_NAME);
        tableNameHashSet.add(SpotiContract.ArtistQuery.TABLE_NAME);

        mContext.deleteDatabase(SpotiDbHelper.DATABASE_NAME);
        SQLiteDatabase db = new SpotiDbHelper(this.mContext).getWritableDatabase();
